...
public final class BytesUtils {
    ...
    public static String string(final byte[] source) {
        return null == source ? StringUtils.EMPTY : new String(source, UTF8);
    }
    ...
    public static String gbkString(final byte[] source) {
        return null == source ? StringUtils.EMPTY : new String(source, GBK);
    }
    ...
    public static String resource2String(final String resource) {
        try {
            return BytesUtils.string(new ClassPathResource(resource).getInputStream());
        } catch (IOException e) {
