...
public final class ThreadFactoryUtils {
    private static final Logger LOG = LoggerFactory.getLogger(ThreadFactoryUtils.class);
    private static final ExecutorService CAPTURES = Executors.newFixedThreadPool(16, of("CAPTURES"));
    ...
    public static ExecutorService newCachedThreadPool(String name) {
        return new ThreadPoolExecutor(0, MAX_THREADS, 60L, TimeUnit.SECONDS, new SynchronousQueue<>(), of(name));
    }
