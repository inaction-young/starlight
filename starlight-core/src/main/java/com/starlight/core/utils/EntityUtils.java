...
import com.starlight.core.enums.IEnum;
...
public final class EntityUtils {
    ...
    public static <T> T map2Bean(final Map<String, Object> source, final Class<T> clazz) {
        return JsonUtils.parseObject(source instanceof JSONObject ? source.toString() : new JSONObject(source).toString(), clazz);
    }
    ...
    public static void setProperty(final Object bean, final String name, final Object value) {
        ...
        try {
            ...
            if ((IEnum.class.isAssignableFrom(fClazz) || Enum.class.isAssignableFrom(fClazz)) && vClazz.equals(String.class)) {
    ...
    public static Field findField(final Class<?> clz, final String fieldName) {
        ...
        if (CollectorUtils.isEmpty(fcMap)) {
    ...
    public static Object convertTypeValue(final String value, final Class clazz, final String dateFormat) {
        if (Boolean.class.equals(clazz)) {
            ...
            return DateUtils.ofDate(value, Enum.valueOf(DateFormat.class, dateFormat));
        } else if (IEnum.class.isAssignableFrom(clazz) || Enum.class.isAssignableFrom(clazz)) {
